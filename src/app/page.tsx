...
export const metadata: Metadata = {
  title: "CodeSense AI - AI-Powered Code Analysis & Documentation",
  description:
    "CodeSense AI simplifies developer collaboration with automatic documentation, intelligent search, commit summaries, and contextual insights. Transform your codebase understanding today.",
  keywords: [
    "AI code analysis",
  ...
  authors: [{ name: "CodeSense AI Team" }],
  openGraph: {
    title: "CodeSense AI - AI-Powered Code Analysis",
    description:
      "Transform your codebase with AI-powered documentation and insights",
    type: "website",
    locale: "en_US",
  },
  twitter: {
...
const Home = () => {
  return (
    <div className="bg-background text-foreground relative min-h-screen overflow-hidden transition-colors duration-500">
      ...
      <main>
        <section
          className="relative z-10 mx-auto mt-32 mb-20 flex max-w-7xl flex-col items-center gap-12 bg-transparent px-6 py-16 pt-20 md:flex-row md:gap-8 lg:px-8"
        ...
        >
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/sign-in"
                className="bg-primary text-primary-foreground group focus:ring-primary flex items-center gap-2 rounded-sm px-6 py-3 font-medium transition-all hover:scale-105 hover:opacity-90 focus:ring-2 focus:ring-offset-2 focus:outline-none active:scale-95"
                aria-label="Get started with CodeSense AI"
              >
                Get Started
              </Link>
        ...
        <section
          className="mb-10 min-h-screen bg-transparent p-4 md:p-8"
            ...
            <div className="border-border bg-card flex min-h-100 flex-col justify-between rounded-xl border p-6 transition-colors duration-500 md:min-h-150 md:p-12 dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
              <div>
                ...
                <p className="text-muted-foreground mb-6 text-sm leading-relaxed md:mb-12 md:text-lg">
                  ...
                  summarized commits, meeting transcripts, and searchable
                  context directly from your codebase.
                </p>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed md:text-sm">
                        Auto-generated documentation and smart summaries help
                        you read and navigate code effortlessly.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-border bg-muted hover:bg-accent rounded-lg border p-4 transition duration-500 md:p-6 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:bg-zinc-800">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed md:text-sm">
                        AI-powered search, commit summaries, and transcripts
                        keep your entire project context one click away.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section
          className="bg-background min-h-screen px-4 py-16 transition-colors duration-500"
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-16 text-center">
              <h1
                ...
                className="text-foreground mb-2 text-4xl md:text-3xl"
              >
